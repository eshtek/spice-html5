...
export var Constants = {
  ...
  SPICE_COMPOSITE_OP_MASK            : 0xff,
  SPICE_COMPOSITE_SRC_FILTER_SHIFT   : 8,
  SPICE_COMPOSITE_MASK_FILTER_SHIFT  : 11,
  SPICE_COMPOSITE_SRC_REPEAT_SHIFT   : 14,
  SPICE_COMPOSITE_MASK_REPEAT_SHIFT  : 16,
  ...
  /* Render's PictOp codes, in the low byte of composite flags. */
  SPICE_COMPOSITE_OP_CLEAR        : 0,
  SPICE_COMPOSITE_OP_SRC          : 1,
  SPICE_COMPOSITE_OP_DST          : 2,
  SPICE_COMPOSITE_OP_OVER         : 3,
  SPICE_COMPOSITE_OP_OVER_REVERSE : 4,
  SPICE_COMPOSITE_OP_IN           : 5,
  SPICE_COMPOSITE_OP_IN_REVERSE   : 6,
  SPICE_COMPOSITE_OP_OUT          : 7,
  SPICE_COMPOSITE_OP_OUT_REVERSE  : 8,
  SPICE_COMPOSITE_OP_ATOP         : 9,
  SPICE_COMPOSITE_OP_ATOP_REVERSE : 10,
  SPICE_COMPOSITE_OP_XOR          : 11,
  SPICE_COMPOSITE_OP_ADD          : 12,
  SPICE_COMPOSITE_OP_SATURATE     : 13,

  SPICE_BITMAP_FMT_8BIT_A         : 10,
